...
[![Build Status](https://travis-ci.org/PrismTech/vortex-builtin-types.svg)](https://travis-ci.org/PrismTech/vortex-builtin-types)

A collection of builtin topic types for developing in Java with PrismTech Vortex
