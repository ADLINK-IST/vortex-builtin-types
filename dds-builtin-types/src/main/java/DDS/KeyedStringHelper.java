...
abstract public class KeyedStringHelper
{
  private static String  _id = "IDL:DDS/KeyedString:1.0";
      ...
      synchronized (org.omg.CORBA.TypeCode.class)
      {
        if (__typeCode == null)
        {
          ...
          _members0[1] = new org.omg.CORBA.StructMember (
            ...
            _tcOf_members0,
            null);
          __typeCode = org.omg.CORBA.ORB.init ().create_struct_tc (DDS.KeyedStringHelper.id (), "KeyedString", _members0);
          __active = false;
        }
      }
    }
  ...
  {
    DDS.KeyedString value = new DDS.KeyedString ();
